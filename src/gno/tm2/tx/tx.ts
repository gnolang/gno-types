...
function createBaseTxSignature(): TxSignature {
  return { pubKey: undefined, signature: new Uint8Array(0), sessionAddr: "" };
}
...
export const TxSignature: MessageFns<TxSignature> = {
  encode(message: TxSignature, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.sessionAddr !== "") {
      writer.uint32(26).string(message.sessionAddr);
    }
    return writer;
  },
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 3: {
            ...
            message.sessionAddr = reader.string();
            continue;
          }
        }
        if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): TxSignature {
    return {
      ...
      sessionAddr: isSet(object.sessionAddr)
        ? globalThis.String(object.sessionAddr)
        : isSet(object.session_addr)
        ? globalThis.String(object.session_addr)
        : "",
    };
  },
  ...
  toJSON(message: TxSignature): unknown {
    ...
    if (message.sessionAddr !== undefined) {
      obj.sessionAddr = message.sessionAddr;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<TxSignature>, I>>(object: I): TxSignature {
    ...
    message.sessionAddr = object.sessionAddr ?? "";
    return message;
  },
};
